...
import { UserSpec, UserArray, IdSpec, UserSpecPlus, UserCredentialsSpec, JwtAuth } from "../models/joi-schemas.js";
  ...
  authenticate: {
    ...
    handler: async function (request, h) {
      try {
        ...
        // This fields have been added to ensure they could be retrieved in Svelte front end
