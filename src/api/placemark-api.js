...
import { PlacemarkSpec, PlacemarkArraySpec, PlacemarkSpecPlus, IdSpec } from "../models/joi-schemas.js";
  ...
  create: {
    ...
    handler: async function (request, h) {
      try {
        ...
        // await db.placemarkStore.addplacemark(category._id, placemark);
        if (placemark) {
          return h.response(placemark).code(201); // this is an http code which means 'created'
        }
    ...
    validate: { params: { id: IdSpec }, payload: PlacemarkSpec },
    response: { schema: PlacemarkSpecPlus, failAction: validationError },
  },
